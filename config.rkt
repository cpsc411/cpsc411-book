...
(define lectures
  ...
  `((,lecture-13-date . "Tail Calls")
    ...
    (,(lecture+ lecture-13-date 10) . "Closures")
    (,(lecture+ lecture-13-date 11) . "Guest Lecture?")
    (,(lecture+ lecture-13-date 12) . "Parsing")
    (,(lecture+ lecture-13-date 13) . "Macro systems & Performance Comparison Wrap up")
    ))
