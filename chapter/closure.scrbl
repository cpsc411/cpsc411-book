...
arguments, return procedures, or call arbitrary variables with an arbitrary
number of arguments.
...
@;@object-code{procedure-arity} value, since this value is exposed to the user, and
...
single form, where each bound expression can refer to any variable in the set of
