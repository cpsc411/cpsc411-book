...
build/index.html: .racodeps assignment/* appendix/*.scrbl chapter/*.scrbl *.scrbl Makefile config.rkt chapter/diagrams/*.rkt
...
sync: build/*.html build/*.cgi
	rsync -avzl --delete --delete-excluded --chmod=Dg+x,g+r build/ cs-411@remote.students.cs.ubc.ca:public_html/2025w2/
