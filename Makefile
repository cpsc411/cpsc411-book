...
build/cpsc411.sxref:
	mkdir -p build
	scribble --dest ./build --dest-name cpsc411 --htmls --info-out build/cpsc411.sxref +m --redirect-main "https://docs.racket-lang.com" `racket -e "(void (write-string (path->string (collection-file-path \"cpsc411.scrbl\" \"cpsc411\"))))"`
