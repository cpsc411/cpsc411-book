...
@(define (notes . _) (void))
@title[#:tag "top" #:tag-prefix "a11:"]{Milestone 11: The CPSC411 Compiler
Encore}
...
At the deadline, we will rerun public and private test suites, and regrade your
final milestone code base.
You will earn up to 100% of marks back on tests.
